...
//******************************** Add a new user ***********************************************
function AddNewUser( $Username, $Password, $Firstname, $SecondName )
{
...
{
	// Fetch the details and return in an array
$tmp = array();
...
connect2database();
$querystr = 'SELECT FROM ' . $Tablename . 'WHERE Userlogin = ' . $Username;
