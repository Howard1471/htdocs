...
if ( ( result1 == true ) && ( result2 == true) ) { return true; } else { return false; }
 
} // End of ValidateUsername

function Create_Profile ()
{
global $T1, $T2, $T3a, $T3b, $T3c, $T4, $T5, $T6, $T7, $S1, $T8, $T9, $T10, $PassHash, $C1, $Testpass ;
$FolderRoot = "Profiles/";
$Username = strtolower( $T1 );
$FolderLocation = $FolderRoot.$Username;
$filename = $FolderLocation."/Register.txt";
...
<form action="../index.htm" Target = "_parent" style="text-align: left">
